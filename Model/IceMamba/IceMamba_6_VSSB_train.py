...
from IceMamba_6_VSSB import VSSM
import numpy as np
...
class MyDataset(Dataset):
    def __init__(self, var_dict, mask, time_dict, num_forecast):
...
def data_transform(NSIDC_path, ERA5_path, ORAS5_path, mask_path,
    ...
    if year_range != '':
        ...
        train_data = MyDataset(var_dict, mask, time_dict, num_forecast)
        train_data = DataLoader(train_data, batch_size=bs, shuffle=shuffle, num_workers=20)

        return train_data

# 用于 target year的9月预测
def data_transform_sep(NSIDC_path, ERA5_path, ORAS5_path, mask_path,
                   time_dict, preprocess_dict,
                   num_forecast,
...
def train():
    ...
    NSIDC_path = '../12-4_bash/data_preprocess/dataset/G2202_SIC/g2202_197901_202312.npy'
    ERA5_path = '../12-4_bash/data_preprocess/dataset/ERA5/'
    ORAS5_path = '../12-4_bash/data_preprocess/dataset/ORAS5/'
    mask_path = '../12-4_bash/data_preprocess/dataset/g2202_land.npy'
    ...
    logger = TensorBoardLogger('tb_logs_vmamba_' + train_type, name='vmamba')
